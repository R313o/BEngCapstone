...
#define NORMAL_INPUT 	0.00000012f
#define NORMAL_OUTPUT 	8388608.0f
/* USER CODE END PD */
...
static int32_t saiInput[BUFFER_SIZE*4];
static int32_t saiOutput[BUFFER_SIZE*4];

float32_t inR[BUFFER_SIZE];
float32_t inL[BUFFER_SIZE];

float32_t *outR;
float32_t *outL;
float32_t outR1[BUFFER_SIZE];
float32_t outL1[BUFFER_SIZE];
float32_t outR2[BUFFER_SIZE];
float32_t outL2[BUFFER_SIZE];
...
void normal2bits(float32_t* inR, float32_t* inL, int32_t* output)
{
	...
	/*arm_offset_f32(inL, 1.0f, inL, BUFFER_SIZE);
	arm_offset_f32(inR, 1.0f, inR, BUFFER_SIZE);
	arm_scale_f32(inL, NORMAL_OUTPUT, inL, BUFFER_SIZE);
	arm_scale_f32(inR, NORMAL_OUTPUT, inR, BUFFER_SIZE);
